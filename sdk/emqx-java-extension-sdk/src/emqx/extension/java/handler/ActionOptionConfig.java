...
public final class ActionOptionConfig {
	...
	public static ActionOptionConfig getDefault() {
		...
		option.set(Keys.MESSAGE_PUBLISH_TOPICS, "t/#");
		option.set(Keys.MESSAGE_DELIVERED_TOPICS, "t/#");
		option.set(Keys.MESSAGE_ACKED_TOPICS, "t/#");
		option.set(Keys.MESSAGE_DROPPED_TOPICS, "t/#");
